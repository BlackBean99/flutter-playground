...
class MyPageController extends GetxController {
  ...
  Future<void> loadPreviousWeeklyPixelCount() async {
    selectedWeekStartDate =
        selectedWeekStartDate.subtract(const Duration(days: 7));
    selectedWeekEndDate = selectedWeekEndDate.subtract(const Duration(days: 7));
    _loadWeeklyPixelCount();
  }

  Future<void> loadNextWeeklyPixelCount() async {
    selectedWeekStartDate = selectedWeekStartDate.add(const Duration(days: 7));
    selectedWeekEndDate = selectedWeekEndDate.add(const Duration(days: 7));
    _loadWeeklyPixelCount();
  }
